...
Feature engineering (Month, Day of Week, Age Group)
...
Interactive Filters for Department, Gender, and Admission Status
...
Increase staffing levels in departments with consistently high waiting times, particularly Neurology and Physiotherapy.
Continuously monitor patient waiting times to identify operational bottlenecks.
Improve patient communication and service quality to enhance satisfaction.
Use monthly patient trends to optimize workforce scheduling and resource allocation.
Perform regular department performance reviews using interactive Tableau dashboards.
Implement data-driven decision-making practices to improve overall Emergency Room efficiency.
🎯 Project Outcome
...
Cleaned and transformed raw healthcare data using Python.
Generated business-focused insights through SQL.
Developed an interactive Tableau dashboard for visualization.
Identified operational bottlenecks affecting patient flow.
Provided actionable recommendations for improving hospital efficiency and patient care.
Demonstrated practical expertise in Data Cleaning, Exploratory Data Analysis (EDA), SQL Querying, Business Intelligence, Data Visualization, and Dashboard Development.
✅ Conclusion
